...
void TBNMesh::SetupMesh()
{
	...
	glBufferData(GL_ARRAY_BUFFER, vertices.size() * sizeof(TBNVertex), vertices.data(), GL_STATIC_DRAW);
	...
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, sizeof(TBNVertex), (void*)offsetof(TBNVertex, position));
	glEnableVertexAttribArray(1);
	glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, sizeof(TBNVertex), (void*)offsetof(TBNVertex, normal));
...
void TBNMesh::Draw(std::weak_ptr<Shader> shaderRef)
{
